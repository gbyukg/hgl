<?php /* Smarty version 2.6.26, created on 2011-11-07 15:29:02
         compiled from dbtxx_01.php */ ?>
    ...
    <tr height="0">
      ...
      <td></td>
		...
		<tr>
		    ...
		    <td >
		        <input id="CKBH" name="CKBH" style="width: 80px" type="text" maxlength="8" class="editable"/>
		    </td>				
		    <th>
		       打包台:
		    </th>
		    <td >
		        <input id="DBTBH" name="DBTBH" style="width: 80px" type="text" maxlength="8"  class="editable" />
		    </td>	    
