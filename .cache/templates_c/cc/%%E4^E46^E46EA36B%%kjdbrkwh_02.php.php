<?php /* Smarty version 2.6.26, created on 2011-05-27 17:28:20
         compiled from kjdbrkwh_02.php */ ?>
...
<body>
	 <div id="top">
         <table width="100%" cellpadding="0" cellspacing="0">
             <tr>
                <td class="title">仓储模块>>库间调拨出库单选择</td>
	 ...
	 <form name="form1" id="form1" style="display:inline;margin:0px;">
	  ...
	  <table width="100%" cellpadding="0" cellspacing="1" class="form">
        <tr>
            ...
            <td width="20%"></td>
            <td style="text-aling:left" width="20%" >
...
/images/btn_reset.gif"/>
        ...
        <tr>
            <th width="100px">调出仓库：</th>
		    <td width="200px">
		        <input id= "DCCK" name="DCCK" type="text" style="width: 90%" readonly class="readonly"/>
		        <input id= "DCCKBH" name="DCCKBH" type="hidden" />
		    </td> 
		    <th width="100px">调入仓库：</th>
		    <td width="200px">
		        <input id= "DRCK" name="DRCK" type="text" style="width: 90%" readonly class="readonly"/>
