<?php /* Smarty version 2.6.26, created on 2011-04-27 16:18:40
         compiled from kjdbrkqr_02.php */ ?>
...
<body>
    ...
    <div id="vspace"></div>
    <div id="body">
        <input type="hidden" id="ckbh" value="<?php echo $this->_tpl_vars['ckbh']; ?>
">
        <!----------- 数据列表 ------------------>
