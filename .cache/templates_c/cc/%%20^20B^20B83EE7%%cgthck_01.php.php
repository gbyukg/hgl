<?php /* Smarty version 2.6.26, created on 2011-04-02 14:06:13
         compiled from cgthck_01.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cgthck_01.php', 118, false),)), $this); ?>
...
" />
        ...
        <th>单据编号:</th>
        <td>
        	<label id="CKDBH"  style="color:#ccc; width:115px">--保存时自动生成--</label>
        </td>
        <th>采购退货单:<span style="color: red">*</span></th>
        <td>
        	<input id="CGTHD" name="CGTHD" type="text" style="width: 115px" class="editable" />
        	<input id="YRKDBH" name="YRKDBH" type="hidden" />
        </td>
        <th>增&nbsp;值&nbsp;税:</th>
        <td>
        	<input id="SHFZZHSH" name="SHFZZHSH" type="checkbox"  disabled/><label for="SHFZZHSH" >是否增值税</label>
        </td>
    </tr>
    <tr>
        <th>单位编号:</th>
    ...
    <tr>
        <th>地&nbsp;&nbsp;&nbsp;&nbsp;址:</th>
        <td colspan="3">
        	<input id="DIZHI" name="DIZHI" type="text" maxlength="100" style="width: 308px" readonly class="readonly" />
        </td>
    ...
    <tr>
    	<th>付款方式:</th>
        <td>
            <select id="FKFSH" name="FKFSH" style="width: 118px" disabled>
        ...
        <th>是否配送:</th>
        <td>
        	<input type="checkbox" id="SHFPS" name="SHFPS" disabled><label for="SHFPS">配&nbsp;&nbsp;&nbsp;&nbsp;送</label>
        </td>
        <th>扣&nbsp;&nbsp;&nbsp;&nbsp;率:</th>
        <td>
        	<input id="KOULV" name="KOULV" type="text" maxlength="5" style="width: 115px" readonly class="editable_num"/>
        </td>
    </tr>
    <tr>
        <th>备&nbsp;&nbsp;&nbsp;&nbsp;注:</th>
...
<div id="loading" style="text-align: left;Z-INDEX: 1;position:absolute;left:200px;top:300px;FILTER:Alpha(opacity=80);background-color: #FFF;border: 1px dashed #999999;width:50px;padding:10px;display:none">
