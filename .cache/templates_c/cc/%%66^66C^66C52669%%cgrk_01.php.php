<?php /* Smarty version 2.6.26, created on 2011-04-20 16:40:12
         compiled from cgrk_01.php */ ?>
...
"/></td>
			...
			<td><input id="SHFZZHSH" name="SHFZZHSH" type="checkbox" disabled>是否增值税</input>
						...
						<th>预入库单号:</th>
			<td><span id="CGDBH" class="span_normal" style="width:115px">请双击选择</span>
		...
		<tr>
					<th>地&nbsp;&nbsp;&nbsp;&nbsp;址:</th>
			<td colspan="3"><span id="DIZHI" class="span_normal" style="width:115px"></span><!--
		...
		<tr>
			<th>备&nbsp;&nbsp;&nbsp;&nbsp;注:</th>
			<td colspan="5"><input id="BEIZHU" name="BEIZHU" maxlength="500" type="text"
				style="width: 507px" class="editable" /></td>
