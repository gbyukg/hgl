<?php /* Smarty version 2.6.26, created on 2011-05-09 14:58:52
         compiled from dyqkwxx_05.php */ ?>
...
<body>
  <div id="top">
    ...
    <input type="hidden" id="CKBH" name="CKBH" value=<?php echo $this->_tpl_vars['ckbh']; ?>
 />
     <input type="hidden" id="flg" value="<?php echo $this->_tpl_vars['GET']['flg']; ?>
">
