<?php /* Smarty version 2.6.26, created on 2011-04-15 11:12:57
         compiled from lszx_01.php */ ?>
    ...
    <tr height="0">
      ...
      <td></td>
		  		...
		  		<tr>
				    <th >周转箱号:</th>
				    <td >
				        <input id= "ZHZHXH" name="ZHZHXH" type="text" style="width: 115px" maxlength="10" class="editable"/>
				       
				    </td> 
				    <th >对应暂存区:</th>
				    <td >
				        <span id= "DYZCQ" name="DYZCQ"  style="width: 115px" class="span_num"></span>
				        
				    </td>
					
					<th >传送带出口:</th>
				    <td colspan="6">
				        <span id= "CHSDCHK" name="CHSDCHK"  style="width: 115px" class="span_num"><?php echo $this->_tpl_vars['rec']['CHSDCHK']; ?>
</span>
				        
				    </td>
				    <input type="hidden" id="CKBH" name="CKBH" value="<?php echo $this->_tpl_vars['rec']['CKBH']; ?>
"/>
				    <input type="hidden" id="DYTM" name="DYTM" value="<?php echo $this->_tpl_vars['DYTM']; ?>
"/> 
	      </table>
