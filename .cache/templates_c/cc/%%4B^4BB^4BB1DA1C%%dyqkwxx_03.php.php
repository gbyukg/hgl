<?php /* Smarty version 2.6.26, created on 2011-05-10 17:07:33
         compiled from dyqkwxx_03.php */ ?>
...
" />
    <input id="BGZH" name="BGZH" type="hidden" value="<?php echo $this->_tpl_vars['rec']['BGZH']; ?>
" />
...
" /> 
<!--             <input id="YCKBH" name="YCKBH" type=text style="width: 200px" class="editable" value="<?php echo $this->_tpl_vars['rec']['CKBH']; ?>
" /> -->
        <?php else: ?> 
...
" />
<!--            <input id="YDYQBH" name="YDYQBH" type="text" style="width: 200px" class="readonly" readonly="readonly" value="<?php echo $this->_tpl_vars['rec']['DYQBH']; ?>
" />-->
        <?php else: ?>
    ...
    <tr>
        ...
        <td>
        <?php if ($this->_tpl_vars['action'] == 'update'): ?> 
          <input id="DYQKWBH" name="DYQKWBH" type="text" maxlength="6" style="width: 200px" readonly="readonly" class="readonly" value="<?php echo $this->_tpl_vars['rec']['DYQKWBH']; ?>
" />
<!--          <input id="YDYQKWBH" name="YDYQKWBH" type="text" maxlength="6" style="width: 200px" class="editable" value="<?php echo $this->_tpl_vars['rec']['DYQKWBH']; ?>
" /> -->
        <?php else: ?> 
