<?php /* Smarty version 2.6.26, created on 2011-06-13 09:20:15
         compiled from yrkdxg_02.php */ ?>
...
<form name="form1" id="form1" style="display:inline;margin:0px;">
    ...
    <td></td>
        ...
        <tr>
            ...
            <td>
                 <input id="KPRQ" name="KPRQ" type="text" style="width: 115px" class="readonly" value="<?php echo $this->_tpl_vars['rec']['KPRQ']; ?>
"/>
            </td>
            <th>预入库单编号:</th>
            <td>
                 <span id="YRKDBH" name="YRKDBH" class="span_normal" style="width:115px"><?php echo $this->_tpl_vars['rec']['YRKDBH']; ?>
</span>
            </td>
...
"/>
            ...
            <th>采购单号:</th>
            <td>
                 <span id="CGDBH" name="CGDBH" class="span_normal" style="width:115px"><?php echo $this->_tpl_vars['rec']['CKDBH']; ?>
</span>
            </td>
        </tr>
        <tr>
            <th>单位编号:</th>
            <td>
                 <span id="DWBH" name="DWBH" class="span_normal" style="width:115px"><?php echo $this->_tpl_vars['rec']['DWBH']; ?>
</span>
            </td>
            <th>单位名称:</th>
            <td colspan="3">
                 <span id="DWMCH" name="DWMCH" class="span_normal" style="width:311px"><?php echo $this->_tpl_vars['rec']['DWMCH']; ?>
</span>
            </td>
            </td>
            <th>电&nbsp;&nbsp;&nbsp;&nbsp;话:</th>
            <td>
                 <span id="DHHM" name="DHHM" class="span_normal" style="width:115px"><?php echo $this->_tpl_vars['rec']['DHHM']; ?>
</span>
            </td>
        </tr>
        <tr>
            <th>地&nbsp;&nbsp;&nbsp;&nbsp;址:</th>
            <td colspan="5">
                 <span id="DIZHI" name="DIZHI" class="span_normal" style="width:115px"><?php echo $this->_tpl_vars['rec']['DIZHI']; ?>
</span>
            </td>
            <th>扣&nbsp;&nbsp;&nbsp;&nbsp;率:</th>
            <td>
        ...
        <tr>
            <th>送货清单</th>
            <td>
                <input id="SHQD" name="SHQD" type="text" style="width: 115px" class="editable" value="<?php echo $this->_tpl_vars['rec']['SHQDH']; ?>
"/>
            </td>
            <th>发票编号</th>
            <td>
                <input id="FPBH" name="FPBH" type="text" style="width: 115px" class="readonly" readonly="readonly" value="<?php echo $this->_tpl_vars['rec']['FPBH']; ?>
"/>
            </td>
            <th>业&nbsp;务&nbsp;员:<span style="color: red">*</span></th>
            <td>
                <input id="YWYMCH" name="YWYMCH" type="text" readonly="readonly" style="width: 115px" class="readonly" value="<?php echo $this->_tpl_vars['rec']['YWYXM']; ?>
"/>
                <input id="YWYBH" name="YWYBH" type="hidden" value="<?php echo $this->_tpl_vars['rec']['YWYBH']; ?>
"/>
            </td>
            <th>增&nbsp;值&nbsp;税:</th>
            <td>
        ...
        <tr>
          <th>备&nbsp;&nbsp;&nbsp;&nbsp;注:</th>
                <td colspan="7"><input id="BEIZHU" name="BEIZHU" maxlength="500" type="text" readonly="readonly"  style="width: 703px" class="readonly" value="<?php echo $this->_tpl_vars['rec']['BEIZHU']; ?>
"/>
          </td>
        </tr>
    </table>
