<?php /* Smarty version 2.6.26, created on 2011-08-18 14:10:01
         compiled from cgrkqr_01.php */ ?>
...
"/></td>
			...
			<td><input id="SHFZZHSH" name="SHFZZHSH" type="checkbox" disabled>是否增值税</input>
						...
						<th>预入库单号:</th>
			<td><span id="YRKDBH" class="span_normal" style="width:115px"><?php echo $this->_tpl_vars['yrkdbh']; ?>
</span>
				<input id="CKDBH" name="CKDBH" value="" type="hidden"/>
				<input id="CGDDBH" name="CGDDBH" value="" type="hidden"/>
				<input id="FKFSH" name="FKFSH" value="" type="hidden"/>
			</td>
		</tr>
				<tr>
			<th>单位编号:</th>
			<td><span id="DWBH" class="span_normal" style="width:115px"></span><!--
			<input id="DWBH" name="DWBH" type="text" style="width: 115px"
				readonly="readonly" class="readonly" />
				--></td>
			<th>单位名称:</th>
			<td colspan="3"><span id="DWMCH" class="span_normal" style="width:311px"></span><!--
		...
		<tr>
					<th>地&nbsp;&nbsp;&nbsp;&nbsp;址:</th>
			<td colspan="5"><span id="DIZHI" class="span_normal" style="width:115px"></span><!--
		...
		<tr>
					<th>备&nbsp;&nbsp;&nbsp;&nbsp;注:</th>
			<td colspan="3"><input id="BEIZHU" name="BEIZHU" maxlength="500" type="text"
				style="width: 307px" class="editable" /></td>
						<th>部&nbsp;&nbsp;&nbsp;&nbsp;门:</th>
			<td>
			<!--
...
"/>
			...
			<!--
				...
				<input id="YWYBH" name="YWYBH" type="hidden" value='00000020'/>
				-->
