<?php /* Smarty version 2.6.26, created on 2011-04-15 13:41:14
         compiled from cgrk_04.php */ ?>
...
<body>
   <div id="top">
    ...
    <div id="vspace"></div>
    <div id="body">
           <input type="hidden" id="zhdkqlx" value="<?php echo $this->_tpl_vars['zhdkqlx']; ?>
">
...
">
            ...
            <table width="100%" cellpadding="0" cellspacing="1" class="grid">
             <tr><td>
            <div id="mygrid" style="width:100%;height:240px;background-color:white;overflow:auto"></div>
