<?php /* Smarty version 2.6.26, created on 2011-05-12 09:57:24
         compiled from thqxx_01.php */ ?>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="search" border="0">
      ...
      <td></td>
        ...
        <tr>
         ...
         <th >退货区编号/名称:</th>
         <td width="150px"><input id="THQBH" name="THQBH" type="text" class="editable" style="width:120px"></td>
