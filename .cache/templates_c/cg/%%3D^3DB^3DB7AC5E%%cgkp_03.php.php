<?php /* Smarty version 2.6.26, created on 2011-04-27 16:20:03
         compiled from cgkp_03.php */ ?>
...
/images/btn_reset.gif" />
        ...
        <tr>
            ...
            <td width="20%">
                <input id="SERCHDWBH" name="SERCHDWBH" type="text"  style="width: 90%" class="editable"/>
            </td>
            <th width="10%">
                单位名称：
            </th>
           <td width="20%" colspan="2">
                <input type="text"  id="SERCHDWMCH" name="SERCHDWMCH" style="width: 100%"  class="readonly" disabled/>
            </td>
