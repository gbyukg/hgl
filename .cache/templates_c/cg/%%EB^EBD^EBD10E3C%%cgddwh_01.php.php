<?php /* Smarty version 2.6.26, created on 2011-05-25 17:33:59
         compiled from cgddwh_01.php */ ?>
      ...
      <td></td>
        ...
        <tr>
           ...
           <td >
            ...
            <th>审核数据:</th>
			   <td >    
					<input id="SHHZHT" name="SHHZHT" type="checkbox" />包括已审核数据
				</td>
...
/images/btn_reset.gif" />
        ...
        <tr>
           ...
           <td  >
           		 ...
           		 <span id="SERCHDWMCH" name="SERCHDWMCH"  class="span_normal" style="width: 115px" disabled></span>
            </td>
            <td colspan="4"></td>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="1" class="subtitle">
	   ...
	   <tr>
	       <td>
		       <div id="#grid_main" style="width:100%;height:180px;background-color:white;"></div>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="1" class="grid">
	             <tr><td>
	            <div id="#grid_mingxi" style="width:100%;height:150px;background-color:white;"></div>
