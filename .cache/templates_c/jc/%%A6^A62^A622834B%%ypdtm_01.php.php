<?php /* Smarty version 2.6.26, created on 2011-07-27 14:18:29
         compiled from ypdtm_01.php */ ?>
...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td class="title"> 基础管理-一品多条码维护</td>
        <td>
        <div id="toolbar"></div>
        </td>
    </tr>
...
<table width="100%" cellpadding="0" cellspacing="1" class="grid">
    <tr>
        <td>
        <div id="#grid_duotiaoma" style="width: 100%; height:260px; background-color: white; overflow: auto"></div>
        </td>
    </tr>
</table>
</form>
