<?php /* Smarty version 2.6.26, created on 2011-05-09 11:06:19
         compiled from kuqu_01.php */ ?>
...
">
     <input type="hidden" id="CKMCH" name="CKMCH" value="<?php echo $this->_tpl_vars['GET']['ckmch']; ?>
">
...
<?php echo $this->_tpl_vars['GET']['ckmch']; ?>
</span>
                                     </td>
                                     <th width="120px">
                                                                                                    库区编号/库区名称
                                     ...
                                     <td width="180px">
                                    <input type="text" name="SEARCHKEY" id="SEARCHKEY" class="editable" style="width:170px" value="<?php echo $this->_tpl_vars['searchkey']; ?>
" />
                                     </td>
